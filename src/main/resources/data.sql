INSERT INTO movies_play_peliculas (titulo, duracion, genero, clasificacion, fecha_estreno, estado)
...
INSERT INTO movies_play_peliculas (titulo, duracion, genero, clasificacion, fecha_estreno, estado)
VALUES ('El Conjuro', 112, 'TERROR', 3.0, '2013-07-19', 'N')
    ON CONFLICT (titulo) DO NOTHING;
...
INSERT INTO movies_play_peliculas (titulo, duracion, genero, clasificacion, fecha_estreno, estado)
VALUES ('Joker', 122, 'DRAMA', NULL, '2019-10-04', 'N')
    ON CONFLICT (titulo) DO NOTHING;

INSERT INTO movies_play_peliculas (titulo, duracion, genero, clasificacion, fecha_estreno, estado)
VALUES ('Toy Story', 81, 'ANIMADA', 4.5, '1995-11-22', 'N')
    ON CONFLICT (titulo) DO NOTHING;
...
INSERT INTO movies_play_peliculas (titulo, duracion, genero, clasificacion, fecha_estreno, estado)
VALUES ('Gladiator', 148, 'ACCION', 7.0, '2024-11-15', 'D')
    ON CONFLICT (titulo) DO NOTHING;